...
class Window(QtGui.QMainWindow):
	...
	def run_button(self):
		...
		# French - Radio
			...
			print("canal144fr")
			vrTest(ADB_DEVICE, WAV_PATH_NAME, "fr-CA", "Radio/canal144fr")
		elif self.cmdBox.currentText() == "FM 97.1":
			print("fm97.1fr")
			vrTest(ADB_DEVICE, WAV_PATH_NAME, "fr-CA", "Radio/fm97.1fr")
		elif self.cmdBox.currentText() == "SiriusXM 144":
			print("siriusXM144fr")
			vrTest(ADB_DEVICE, WAV_PATH_NAME, "fr-CA", "Radio/siriusXM144fr")
...
def vrOutput(lang):
	...
	try:
		...
		f.write("Google thinks you said '" + r.recognize_google(audio_data=audio, language=lang) + "'")
		print("Done.")
